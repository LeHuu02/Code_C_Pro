...
/*function kieu du lieu struct*/
nhanvien luongMax(nhanvien nv[], int n)
{
    int a, i, max = nv[0].luong;
    for(i = 1; i < n; i++)
    {
        if(nv[i].luong > max)
        {
    ...
    /*in ra thong tin nhan vien co luong max*/
    // printf("\nthong tin nhan vien co luong max: \n");
    // printf("ma nv: %s\t", nv[a].mnv);
    // printf("ten: %s\t\t", nv[a].hoten);
    // printf("chuc vu: %s\n", nv[a].chucvu);
    // printf("luong: %d\t\t", nv[a].luong);
    // printf("thuong : %d", nv[a].thuong);
...
int main()
{
    ...
    /*khoi tao cn co gia tri tra ve cua function kieu struct*/
    nhanvien nv1 = luongMax(nv,n);

    /*in ra thong tin nhan vien co luong max*/
    printf("\nthong tin nhan vien co luong max: \n");
    printf("ma nv: %s\t", nv1.mnv);
    printf("ten: %s\t\t", nv1.hoten);
    printf("chuc vu: %s\n", nv1.chucvu);
    printf("luong: %d\t\t", nv1.luong);
    printf("thuong : %d", nv1.thuong);
